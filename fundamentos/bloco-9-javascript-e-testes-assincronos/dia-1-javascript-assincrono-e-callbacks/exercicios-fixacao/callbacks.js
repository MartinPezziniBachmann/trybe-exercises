...
console.log(getUser2(userFullName)); // complete a chamada da função getUser de modo que o retorno seja: "Hello! My name is Ivan Ivanovich"
console.log(getUser2(userNationality)); // complete a chamada da função getUser de modo que o retorno seja: "Ivan is Russian"

// Exercicio de fixação 2
const delay = (maxMilliseconds = 5000) => Math.floor(Math.random() * maxMilliseconds);

const getUser3 = (callback) => {
  setTimeout(() => {
    const user = {
      firstName: "Ivan",
      lastName: "Ivanovich",
...
getUser3(userFullName); // deve imprimir "Hello! My name is Ivan Ivanovich" depois de um certo tempo
getUser3(userNationality); // deve imprimir "Ivan is Russian" depois de um certo tempo